...
const courses = [
  {
    id: 1,
    title_en: "Excel VBA Automation Mastery: Beginner to Advanced",
    title_pt: "Excel VBA Automação Mastery: Do Iniciante ao Avançado",
    description_en: "Learn Excel VBA from scratch and automate tasks with hands-on projects.",
    description_pt: "Domine o Excel VBA com automações práticas e desenvolva soluções avançadas.",
    category: "technical",
    language: "pt",
    rating: 4.9,
    reviews: 1280,
    ...
    duration: "12 hours",
    hotmart_link: "https://go.hotmart.com/R105548973B",
    image: "assets/images/DomineoExcelVBA.png",
    modules: [
      "Introdução ao VBA e o ambiente do Excel",
      "Gravação e edição de macros",
      "Controle de fluxo e lógica VBA",
      "Automação de relatórios e dashboards",
      "Manipulação avançada de dados e fórmulas",
      "Boas práticas e otimização de código"
    ]
  },
  {
    id: 2,
    title_en: "Learn Revit Fast: Beginner to Professional",
    title_pt: "Learn Revit Fast: Do Iniciante ao Profissional",
    description_en: "Master Revit quickly with practical BIM workflows and professional modeling techniques.",
    description_pt: "Aprenda Revit rápido com fluxos de trabalho BIM práticos e técnicas profissionais de modelagem.",
    category: "technical",
    language: "pt",
    rating: 4.8,
    reviews: 950,
    ...
    duration: "15 hours",
    hotmart_link: "https://go.hotmart.com/Q105641806Y",
    image: "assets/images/Untitleddesign202.png",
    modules: [
      "Introdução ao Revit e interface BIM",
      "Modelagem de paredes, portas e janelas",
      "Famílias paramétricas e componentes",
      "Documentação e pranchas de projeto",
      "Renderização básica e exportações",
      "Dicas profissionais para fluxos de trabalho eficientes"
    ]
  },
  {
    id: 3,
    title_en: "Magic MakeUp – Complete Course",
    title_pt: "Magic MakeUp – Curso Completo",
    description_en: "Become a makeup pro with step-by-step techniques for day, evening, and special occasion looks.",
    description_pt: "Torne-se um profissional da maquiagem com técnicas passo a passo para looks do dia, noite e ocasiões especiais.",
    category: "creative",
    language: "pt",
    rating: 4.7,
    reviews: 820,
    ...
    duration: "10 hours",
    hotmart_link: "#",
    image: "assets/images/MAGICMAKEUP.png",
    modules: [
      "Fundamentos da maquiagem e preparação de pele",
      "Técnicas de contorno e iluminação",
      "Olhos esfumados e delineados perfeitos",
      "Maquiagem para pele madura e diferentes tipos de rosto",
